...
export default function Landing() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f8f8fc] text-[#1f2026]">
      ...
      <nav className="relative z-10 mx-auto flex max-w-[1240px] items-center justify-between px-5 py-5 sm:px-8 lg:px-10 lg:py-7"><div className="flex items-center gap-3"><Mark /><div><p className="text-[17px] font-bold tracking-[-0.02em]">Studyflow</p><p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#73737f]">Exam companion</p></div></div><div className="hidden items-center gap-8 text-sm font-semibold text-[#676873] md:flex"><a href="#how-it-works" className="transition-colors hover:text-primary">How it works</a><a href="#principles" className="transition-colors hover:text-primary">Principles</a><Button type="button" variant="outline" className="h-10 rounded-full border-[#d5d8e5] bg-white/60 px-5 font-bold" onClick={() => navigate("/auth")}>Sign in</Button></div><Button type="button" variant="ghost" size="icon" className="rounded-full md:hidden" onClick={() => navigate("/auth")} aria-label="Open sign in"><Menu className="size-5" /></Button></nav>
