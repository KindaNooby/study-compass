...
export function createInitialPlannerState(now = new Date()): PlannerState {
  ...
  const topics: Topic[] = [
    {
      ...
      mcqAccuracy: 71,
      errorLabel: "Linking evidence to conclusions",
    },
    {
      id: "chemistry.organic",
      subject: "Chemistry",
      name: "Organic reactions",
      unit: "Unit 06 · Carbon chemistry",
      importance: 0.86,
      acquisition: 0.61,
      retention: 0.72,
      application: 0.69,
      ...
      mcqAccuracy: 78,
      errorLabel: "Reaction conditions",
    },
    {
      id: "biology.cells",
      subject: "Biology",
      name: "Cell communication",
      unit: "Unit 02 · Cell biology",
      importance: 0.74,
      acquisition: 0.86,
      retention: 0.81,
      application: 0.77,
      ...
      mcqAccuracy: 84,
      errorLabel: "Signal pathway order",
    },
    {
      id: "chemistry.equilibrium",
      subject: "Chemistry",
      name: "Equilibrium",
      unit: "Unit 03 · Physical chemistry",
      importance: 0.68,
      acquisition: 0.48,
      retention: 0.57,
      application: 0.52,
      ...
      mcqAccuracy: 63,
      errorLabel: "Reading the direction of shift",
    },
  ];
  ...
  const activities: StudyActivity[] = [
    ...
    },
    {
      ...
      title: "Genetics: evidence questions",
    ...
    },
    {
      ...
      title: "Organic reactions: first pass",
    ...
    },
    {
      ...
      date: day(1),
      type: "fsrs_review",
      title: "Cell communication reviews",
    ...
    },
    {
      ...
      date: day(1),
      type: "mcq_practise",
      title: "Organic reactions: quick checks",
      topicId: "chemistry.organic",
      subject: "Chemistry",
      plannedMinutes: 35,
      completedMinutes: 0,
    ...
    },
    {
      ...
      title: "Genetics error correction",
      topicId: "biology.genetics",
      subject: "Biology",
      plannedMinutes: 25,
      completedMinutes: 0,
    ...
    },
    {
      ...
      plannedMinutes: 45,
      completedMinutes: 0,
      detail: "Biology + Chemistry · timed",
